...
% Last modified: 16-Oct-2018    
    ...
    methods (Static)
        function[trD,tstD] = main()
            %try any random seed here
            rng(7);
            scales = [8, 16, 32, 64];
            normH = 16;
            normW = 16;
            ...
            fprintf('Cross validation accuracy %d',cv_accuracy);
        ...
        function bowCs = learnDictionary(scales, normH, normW)
            ...
            % load train ids
            trIds = ml_load('hw5data/bigbangtheory_v3/train.mat', 'imIds'); 
            ...
            for i=1:length(trIds)
                ...
                im = imread(sprintf('hw5data/bigbangtheory_v3/%06d.jpg', trIds(i)));
        ...
        function D = cmpFeatVecs(imIds, scales, normH, normW, bowCs)
            ...
            for i=1:n
                ...
                im = imread(sprintf('hw5data/bigbangtheory_v3/%06d.jpg', imIds(i)));                                
